...
<head>
  ...
  <link rel="stylesheet" href="/css/clasesEstilos.css">
  </head>
<body >
...
<div class="container-fluid mt-5">
    <div class="row justify-content-center">
      ...
      <div class="card mb-2" style="width:79vw;">
        <p style="" id="tituloSeccion">Book a Lesson</p>
      </div>
...
<script
 ...
 <script src="/js/clases/capturarIdClase.js"></script>
 <script src="/js/clases/mostarLessonBoock.js"></script>
 <script src="/js/clases/mostrarDescricripcion.js"></script>
 
<?php $__env->stopSection(); ?>
</body>
</html>
<?php echo $__env->make('plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bpb\resources\views/boockLesson.blade.php ENDPATH**/ ?>